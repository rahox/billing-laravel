export const routes = [
  { path: '/', redirect: '/dashboard' },
  {
    ...
    children: [
      ...
      { path: 'delivery-orders', component: () => import('@/pages/delivery-orders.vue'), meta: { permission: 'delivery_orders.view' } },
      { path: 'delivery-orders/:id', component: () => import('@/pages/delivery-order-detail.vue'), meta: { permission: 'delivery_orders.view' } },
